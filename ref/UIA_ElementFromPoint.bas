Attribute VB_Name = "UIA_ElementFromPoint"
...
Private Declare PtrSafe Function DispCallFunc Lib "oleAut32.dll" ( _
    ...
    ByVal offsetinVft As LongLong, _
...
Sub test()
    ...
    Set elem = ElementFromPoint(pt)
    Debug.Print "------------------------------------------"
    Debug.Print "LocalizedControlType", elem.CurrentLocalizedControlType
    Debug.Print "Name", elem.CurrentName
    Debug.Print "AcceleratorKey", elem.CurrentAcceleratorKey
    Debug.Print "AccessKey", elem.CurrentAccessKey
    Debug.Print "AutomationId", elem.CurrentAutomationId
    Debug.Print "ClassName", elem.CurrentClassName
    Debug.Print "HelpText", elem.CurrentHelpText
    Debug.Print "ItemType", elem.CurrentItemType
    Debug.Print "FrameworkId", elem.CurrentFrameworkId
    Debug.Print "ItemStatus", elem.CurrentItemStatus
    Debug.Print "AriaRole", elem.CurrentAriaRole
    Debug.Print "AriaProperties", elem.CurrentAriaProperties
    Debug.Print "ProviderDescription", elem.CurrentProviderDescription
